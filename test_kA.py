"""
TEST MIT kA-Werten - Stabilerer Ansatz
=======================================
"""
...
print("\n" + "="*70)
print("TEST MIT kA-Werten - R410A B5/W35".center(70))
print("="*70 + "\n")
...
# Komponenten mit kA-Werten (stabiler!)
evap.set_attr(pr1=0.98, pr2=0.98, kA=1.5)  # kA statt ttd!
cond.set_attr(pr1=0.98, pr2=0.98, kA=1.5)  # kA statt ttd!
comp.set_attr(pr=3.0)  # Druckverhältnis

# Kältemittel
c0.set_attr(m=0.05)
c1.set_attr(td_dew=5)  # 5K Überhitzung am Verdampferausgang

print("✓ Parameter gesetzt")

# Startwerte
c0.set_attr(p0=8, T0=-2)
c1.set_attr(p0=8, T0=0)
c2.set_attr(p0=24, T0=50)
c3.set_attr(p0=24, T0=38)
c4.set_attr(p0=8, T0=-2)

print("✓ Startwerte gesetzt\n")
...
try:
    ...
    if nw.status == 0:
        ...
        print(f"  T_evap:     {c1.T.val:.1f} °C")
        print(f"  T_cond:     {c2.T.val:.1f} °C")
        print("="*70 + "\n")
    else:
